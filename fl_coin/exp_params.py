...
ATTENUATION_DOC_PATH='' # path to a CSV describing the effect of attenuation
E_FLUOR=8. # fluorescence energy used for the purpose of attentuation correction (keV)
